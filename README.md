...
# Project Description 📝
VueTech is a fully functional ed-tech platform that enables users to create, consume, and rate educational content. <br/>
...
| Section                 | Description                                  |
|-------------------------|----------------------------------------------|
| [VueTech Aim](#VueTech-aim-)        | 📚 Overview of VueTech's goals            |
...
## System Architecture 🏰
<br/>
☝ The VueTech ed-tech platform consists of three main components:  <br/>
...
<br/>
Here is a high-level diagram that illustrates the architecture of the VueTech ed-tech platform:
<img width='60%' src='https://github.com/vivek-panchal/Ed-Tech-Platform/blob/main/screenshots/Architecture%20Diagram.png' />


<hr/>

#### The front end of VueTech has all the necessary pages that an ed-tech platform should have. Some of these pages are: 
...
- **Cloud-based Media Management ☁️ :** VueTech uses Cloudinary, a cloud-based media management service, to store and manage all media content, including images, videos, and documents.
...
The back-end of VueTech uses several data models and database schemas to manage data, including:
...
# Important
live link add C:\Users\viraj\Desktop\main\Ed-Tech-Platform-main\Ed-Tech-Platform-main\server\mail\templates\contactFormRes.js   this is mail template 