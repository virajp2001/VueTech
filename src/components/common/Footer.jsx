...
// Images
import VueTechLogo from "../../assets/Logo/Logo-Full-Light.png";
        ...
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              <img src={VueTechLogo} alt="" className="object-contain" />
      ...
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-14 text-sm">
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            ...
            <span> © 2024 VueTech</span>
          </div>

          <div className="flex items-center">
            <a href="https://www.linkedin.com/in/viraj-patidar-152821281/" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="https://github.com/virajp2001" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </a>
            <a href="  " className="text-white p-3 hover:bg-richbSlack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImTwitter size={17} />
            </a>
          </div>
